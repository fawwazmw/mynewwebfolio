  ...
  >
    <div class="container">
      <div class="sec-head mb-80">
        <h6 class="sub-title main-color mb-25">Testimonials</h6>
        ...
        >
          <SwiperSlide v-for="(item, i) in data" :key="i">
            <div class="item bord-box radius-15">
              <div class="content">
                <div class="text">
                  <span class="tag sub-title mb-30 main-color">
                    {{ item.section }}
                  </span>
                  <p>{{ item.desc }}</p>
                </div>
                <div class="info mt-40">
                  ...
                  <div class="ml-20">
                    <h6>{{ item.name }}</h6>
                    <span class="sub-title opacity-7">
                      {{ item.subName }}
                    </span>
                  </div>
                  <div class="ml-auto">
...
// Configure Swiper with autoplay for smooth infinite scrolling
const swiperOptions = {
  modules: [Navigation, Autoplay],
  speed: 2000, // Speed of transition between slides (in ms)
